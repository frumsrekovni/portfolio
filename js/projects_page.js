...
const active_project_blocker = document.getElementById("projects_out_of_bound_blocker");
const all_project_checkboxes = document.getElementsByClassName("project_checkbox");
...
function addEventListenerToAllProjects() {
    for (let i = 0; i < all_project_elements.length; i++) {
        all_project_elements[i].addEventListener("click", () => {
            ...
            let projectEl = document.getElementById(projectid);
